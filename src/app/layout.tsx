...
export const metadata: Metadata = {
  ...
  keywords: "Ashim Rudra Paul, Software Engineer, Full Stack Developer, MERN Stack, TypeScript, Next.js, React Native, AWS, Docker, JavaScript, MongoDB, Express.js, Node.js, PostgreSQL, MySQL, Laravel, GraphQL, Prisma, Fastify, Strapi.io, SJ Innovation, elPixala, Sylhet Polytechnic Institute, SPI, Sylhet, Bangladesh",
  authors: [{ name: "Ashim Rudra Paul", url: "https://codewithashim.netlify.app" }],
  ...
  openGraph: {
    ...
    title: "Ashim Rudra Paul | Software Engineer | Full Stack Developer | Backend Engineer",
    description: "Experienced Software Engineer with 2+ years in MERN stack, TypeScript, Next.js, React Native, AWS, Docker, and more. Sylhet Polytechnic Institute graduate. Let's bring your ideas to life with scalable, efficient web solutions!",
    images: [
      {
        url: "/ashim.jpg",
  ...
  twitter: {
    ...
    title: "Ashim Rudra Paul | Software Engineer | Full Stack Developer | Backend Engineer",
    description: "Experienced Software Engineer with 2+ years in MERN stack, TypeScript, Next.js, React Native, AWS, Docker, and more.",
    images: ["/twitter.jpg"],
  },
  // verification: {
  ...
  icons: {
    ...
    apple: [
      { url: "/ashim.jpg", sizes: "180x180", type: "image/jpg" },
    ],
  },
